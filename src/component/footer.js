        ...
        <div className="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row dark:divide-gray-400">
            ...
            <div className="flex flex-col justify-center pt-6 lg:pt-0">
                <div className="flex justify-center space-x-11">
                    ...
                    <a rel="noopener noreferrer" href="mailto:ayushsaha9928@gmail.com" title="Gmail" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-white dark:text-gray-900">
